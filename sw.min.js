(function(){const staticCacheName='static';const version='v1::';const OFFLINE_URL='http://localhost:1313/off/';function updateStaticCache(){const urls=['http://localhost:1313/','http://localhost:1313/manifest.json','/css/index.min.f69f21445e8cf58bac10fb4271cba2e5681222e5cfba63de7454e6297d09fcda4b94f93db9159d44342a7a6c0e2eccf82678901de85bf02047a3ae94cdcbc00f.css','/index.min.js','http://localhost:1313/image/background_hu5fa5007403ed47f8e70c21b28ee4cec6_92766_1400x787_fill_q75_box_smart1.jpg','http://localhost:1313/image/background-dark_huacd336bfb7f5597695f9c32d4115a2aa_1561823_1400x787_fill_q75_box_smart1.jpg',OFFLINE_URL,'http://localhost:1313/index.json'];return caches.open(version+staticCacheName).then((cache)=>cache.addAll(urls)).catch(e=>{console.log("Error = ",e);console.log(e.stack);});}
